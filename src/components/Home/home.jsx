...
const Homesection = () => {
  return (
    <div
      id="home"
      className="bg-blue-50 min-h-screen dark:bg-gray-800 dark:text-white flex items-center mt-24 justify-center px-6 md:px-12"
    >
      <div className="max-w-6xl flex flex-row max-sm:gap-10 max-sm:flex-col-reverse font-poppins items-center">
        <div className="flex-1 text-center md:text-left">
          <div className="font-poppins">
            ...
            <div className="text-4xl text-blue-600 dark:text-white tracking-wide font-bold">
              KEHINDE AFOLABI
            </div>
          </div>
          <p className="text-lg md:text-xl text-gray-600 dark:text-white mt-6">
            A passionate{" "}
            <span className=" font-bold text-black dark:text-blue-500">
              Web Developer{" "}
            </span>
            with a 3+ years experience in creating modern, responsive, and
            beautiful websites through carefully crafted codes.
          </p>
          <div className="mt-10 flex gap-4 items-center max-md:justify-center">
            <Link
              href="/about"
